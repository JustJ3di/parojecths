...
TYPE_LIST_CLUSTER_MJ = 'cluster_mj'
TYPE_DESCRIPTION={TYPE_DRAW:_("Draw"), \
    TYPE_LIST_CLUSTER_MJ: "Cluster majority Judgment", \
...
def validate_dto(v):
    ...
    if result:
        if v.votation_type != TYPE_DRAW and \
           ...
           v.votation_type != TYPE_SIMPLE_MAJORITY and v.votation_type != TYPE_LIST_CLUSTER_MJ and \
